...
public class LinePointRunnerDrawer implements LineDrawer{
	...
	public LinePointRunnerDrawer (LineDrawer drawerOne, LineDrawer drawerTwo, double bezierCoeficient){
